...
function processarDados(dados) {
    ...
    incluirTexto(`Na pesquisa realizada em minha escola no ano de 2024, a amostra de pessoas entrevistadas relatou preferência em utilizar o <span>Instagram</span> em relação a outras redes.`)
}
